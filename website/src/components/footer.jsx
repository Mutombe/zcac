...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Facebook, url: 'https://facebook.com/ZimClimateAction', label: 'Facebook' },
    { icon: FaXTwitter, url: 'https://twitter.com/ZimClimateAction', label: 'Twitter' },
    { icon: Linkedin, url: 'https://linkedin.com/company/cacz', label: 'LinkedIn' },
    { icon: Instagram, url: 'https://instagram.com/ZimClimateAction', label: 'Instagram' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p style={descriptionStyle}>
              ...
              hands that deliver — ensuring Zimbabwe leads Africa in climate action.
            </p>
            <div className="flex space-x-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.background = socialLinkHoverStyle.background}
                  onMouseLeave={(e) => e.currentTarget.style.background = COLORS.neutral.gray800}
                ...
                <li key={link.path}>
                  <Link
                    ...
                    onMouseEnter={(e) => {
                      ...
                      if (underline) underline.style.width = linkUnderlineHoverStyle.width;
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    <span className="link-underline" style={linkUnderlineStyle}></span>
                    {link.name}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-4">
              <li style={contactItemStyle}>
                ...
                <a
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.color = contactLinkHoverStyle.color}
                  onMouseLeave={(e) => e.currentTarget.style.color = COLORS.neutral.gray400}
                >
                  info@cacz.org.zw
                </a>
              </li>
        ...
        <div style={bottomBarStyle}>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p style={copyrightStyle}>
              © {currentYear} Climate Action Council of Zimbabwe. All rights reserved.
            </p>
