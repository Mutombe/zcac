...
const LeadershipSection = () => {
  ...
  const leadership = {
    founders: [
      { name: 'Anglistone T Sibanda', role: 'Founder & CEO', initial: 'AS' },
      { name: 'Lovemore Makota', role: 'Co-Founder & COO', initial: 'LM' },
      { name: 'Advocate Nsikelelo Mafa-Moyo', role: 'Co-Founder & Corporate Counsel', initial: 'NM' },
    ],
    board: [
      { name: 'Professor Norman Nyazema', role: 'Chairman', initial: 'NN' },
      { name: 'Mrs Veronica Gundu Jakarasi', role: 'Vice Chairman', initial: 'VG' },
      { name: 'Mr Darlington Ndava Chiwara', role: 'Treasurer', initial: 'DC' },
      { name: 'Dr Prosper Mutswiri', role: 'Board Member', initial: 'PM' },
      { name: 'Mr Sheperd Chikowore', role: 'Board Member', initial: 'SC' },
      { name: 'Dr Moreangels Mbizah', role: 'Board Member', initial: 'MM' },
    ],
  };
              ...
              {leadership.board.map((person, index) => (
                ...
                >
                  <div style={{
                    width: '4rem',
                    height: '4rem',
                    background: GRADIENTS.yellowService,
                    borderRadius: RADIUS.full,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
